...
/***/ function(module, exports, __webpack_require__) {
	...
	var content_1 = __webpack_require__(67);
	ReactDOM.render(React.createElement(react_router_1.Router, {history: react_router_1.hashHistory}, React.createElement(react_router_1.Route, {path: "/", component: content_1.Content})), document.querySelector("#ct"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var contentList_1 = __webpack_require__(68);
	var DataUtil_1 = __webpack_require__(69);
	var Content = (function (_super) {
	    ...
	    function Content(props) {
	        ...
	        this.componentDidMount = function () {
	            var dataService = new DataUtil_1.DataService();
	            dataService.get("./text.json").then(function (result) {
	    ...
	    Content.prototype.render = function () {
	        ...
	        if (this.state.list) {
	            ContentLog = this.state.list.map(function (log) {
	                return (React.createElement("div", null, React.createElement(contentList_1.ContentList, {data: log})));
	            });
	        }
	        return (React.createElement("div", null, ContentLog));
	    };
	    return Content;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContentList = (function (_super) {
	    ...
	    ContentList.prototype.render = function () {
	        return (React.createElement("div", null, React.createElement("div", null, this.props.data.name), React.createElement("div", null, this.props.data.age), React.createElement("div", null, this.props.data.liked)));
	    };
	    return ContentList;
	}(React.Component));
...
/***/ function(module, exports) {
	...
	var DataService = (function () {
	    ...
	    DataService.prototype.getPromise = function (url) {
	        var _this = this;
